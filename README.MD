...
| :--- | :--- | :--- |
| `schema-loaded` | schema url | Fired when `.src` url is successfully loaded. `.schema` property exposes the newly loaded JSON schema object |
| `schema-errored` | schema url | Fired when `.src` url fails to return a JSON Schema |
