...
Add [dist/pure-form.min.js](dist/pure-form.min.js) and [dist/pure-form.min.css](dist/pure-form.min.css)) files to your project:
...
To run tests, execute the following from within the pure-form folder:
